...
\item \textbf{P. White}, H. Frye, J. Silander Jr, and  A.E. Gelfand (2023), ``Generative Spatial Generalized Dissimilarity Modeling.''
\item \textbf{P. White}, M.Heaton, R. Warr, and G. Schultz (2023), ``Scalable Nonstationary Space-Time Point Process Model for Traffic Accident Data using Spatial Warping.''
\end{enumerate}
