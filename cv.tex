...
\begin{enumerate}[label=$\bullet$]
\item M. Gruen, \textbf{P. White}, and B. Hare (2020+), ``Do Dog Breeds Differ in Pain Sensitivity? Veterinarians and the Public Believe They Do, accepted at \emph{PLoS ONE}.''
...
\item A. Alegr\'ia, P.G. Bissiri, G. Cleanthous,
E. Porcu, and \textbf{P. White}, ``Multivariate Isotropic Random  Fields on Spheres: Nonparametric Bayesian Modeling and $L^p$-Fast Approximations.'' \\ *Under request of one coauthor, authors are listed in alphabetical order
