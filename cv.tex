...
\item D. Sheanshang$^\dagger$, \textbf{P. White}, and D. Keeler (2021+), ``Outlier Accommodation with Semiparametric Density Processes: A Study of Antarctic Snow Density Modelling,'' accepted at \emph{Statistical Modelling}.
...
\item  E. Porcu and \textbf{P. White} (2021+), ``Random Fields on the Hypertorus: Covariance Modeling and Applications,'' in press at \emph{Environmetrics}. 
