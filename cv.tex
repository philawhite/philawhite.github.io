...
%\item D. Sheanshang$^\dagger$, \textbf{P. White}, and D. Keeler, ``Outlier Accommodation with Semiparametric Density Processes: A Study of Antarctic Snow Density Modelling,'' accepted at Statistical Modelling
%\item $^*$A. Alegr\'ia, P.G. Bissiri, G. Cleanthous, E. Porcu, and \textbf{P. White}, ``Multivariate Isotropic Random  Fields on Spheres: Nonparametric Bayesian Modeling and $L^p$-Fast Approximations,''  accepted at Electronic Journal of Statistics
